...
def gameExit():
    ...
    clearOutput()
    if int(option) == 1:
        global exitvar, menuPage, dayCount, hours, hoursSpent, hwFailCount, twocounter, sleep, stats, stats_orig, money, social, knowledge, physical, mental
        exitvar = 0
        dayCount = 0
        hours = 0
        hoursSpent = 0
...
def deathCheck():
    if money[1] < 0 or social[1] < 0 or physical[1] < 0 or mental[1] < 0 or hwFailCount >= 3:
        suddenDeath()
...
def done_status(week, task):
    ...
    options = input("Press enter to return")
    menuPage = 1
...
def guess_the_number():
    ...
    while attempts < 3 and i == 0:
        ...
        if guess == secret_number:
            print(f"Congratulations! the right number is {secret_number} 5 socials points to you!")
            social[1] += 5
            i = 1
            # attempt = 4
            return
    ...
    while menuPage == 0:
        try:
            ...
            if int(option) == 1:
                ...
                twocounter +=1
                # webbrowser.open('https://www.youtube.com/watch?v=7HV3oyxr0Eg')
                print("===============================================================================\n")
                print("\nHA. You thought you could escape!? WELL YOU THOUGHT WRONG MUAHAHAHAHAHAHAHA!\n\n") 
                if twocounter >= 2:
